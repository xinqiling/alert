	...
	Move.prototype.create = function(){
	        ...
	        this.content.innerHTML =" <div class='title' style=color:"+this.obj.color+">"+this.obj.title+"<a id='close'>x</a></div>"
	                +"<div class='content' style=color:"+this.obj.color+">"+this.obj.cont+"<button class='left' id='left1'>确定</button><button class='right' id='right'>取消</button></div>";
